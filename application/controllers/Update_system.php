...
// 				curl_close($ch);
				$add_on_response = json_encode(array());
	...
	public function initialize_update()
	{
		...
		try {
			if (file_exists(' application'))
				@$this->delete_directory(' application');
			if (file_exists('modules'))
				@$this->delete_directory('modules');
			if (file_exists('application/views/site/CustomTheme') && !file_exists('application/views/site/CustomTheme/index.php'))
				@$this->delete_directory('application/views/site/CustomTheme');
